const birdsData = [
  [
    {
      ...
      description:
        'Ку́рица, или дома́шняя ку́рица, — самая многочисленная и распространённая домашняя птица, которая является одомашненной формой банкивской джунглевой курицы. Летает плохо, недалеко. За длительную историю одомашнивания человеком выведено большое количество разнообразных пород кур.',
      image:
        'https://static.mk.ru/upload/entities/2019/01/25/21/articles/detailPicture/03/01/cc/a4/4869aba4bb21273b06d600fb68fc8ff3.jpg',
      audio:
        'https://cdndl.zaycev.net/play/4582423/xZwmx7ijYQO2poS0_RMBtgQd511thXAUaW_w_bu7I5lofxkSeX6jrygbi9HjNBGBQkSvjGy5p7lwxy4DGFyM0KDgNTgZxyZQ85q-K9OrDXctzEtR0sgdD-fmntVm3aOlw4GvZlZ_X1ASF0_Tfne2jejo_a0AQTiUfJk-rJhIpqwgFXwWhpPhpxjaSOpGE2wwTkBbRNrG4MqR8POCHuegKZBRGRhAkJ60BNqM1xZBDA52psVHGHQmwJjAcfIi569UbDkVUAvil_pKSSXb1x7lYCdF1JSvVF8zJ-enajhlRQjclLPXaHW-MX6iYgIhGIDtQVrAlai6EQaSDInnczNtb-X_VtU5FhP77mRYQR18l4YPiMXR/37hjsPtFNhMXKvWOeUQ2cfO2BkVXZwXnWKuGllqziPcpT6CUu3A8CpwD9FQBLMJyULxofyoch3Y-M0dNF8VcDvKzPUlTdC8e'
    },
    {
      id: 2,
      name: 'Журавль',
  ...
  [
    ...
    },
    {
      ...
      description:
        'Пету́х — самец курицы; в общем смысле, самцы всех птиц семейства курообразных. Внешне от курицы обычно отличается крупным гребнем и серьгами, также пышным и часто разноцветным хвостовым оперением',
      image:
        'https://www.meme-arsenal.com/memes/0ac809cc2d9f4d16af38bdc643eab68e.jpg',
      audio:
        'https://cdndl.zaycev.net/play/16877854/DCX4vgowQKaK3L5BgZrHx-b6wmGtVq7i0saFIkZThvJubEsE10AB5oBMWeqMa57LhpbjeDwKgVjnnFj9wuvWFHKlPiJJe2dqvCyh6jVv_ghEXyT37a055rfRJXVan1DfjNUOpCpaVs_cLhHQ2eJrkydm8vaCJEONk7ArZGGva9gZn9oCtABDVrHug01bwrRoATxbTuyIhXS7EkeIAcjEhORXn1k/37hjsPtFNhMXKvWOeUQ2cfO2BkVXZwXnWKuGllqziPcpT6CUu3A8CpwD9FQBLMJyULxofyoch3Y-M0dNF8VcDvKzPUlTdC8e'
    },
    {
      id: 5,
      name: 'Сорока',
